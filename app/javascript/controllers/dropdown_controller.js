...
export default class extends Controller {
  ...
  get _activeClassList() {
    return !this.activeClass ? [[], []] : this.activeClass.split(",").map((classList) => classList.split(" "));
  }

  get _visibleClassList() {
    return !this.visibleClass ? [[], []] : this.visibleClass.split(",").map((classList) => classList.split(" "));
  }

  get _invisibleClassList() {
    return !this.invisibleClass ? [[], []] : this.invisibleClass.split(",").map((classList) => classList.split(" "));
  }

  get _enteringClassList() {
    return !this.enteringClass ? [[], []] : this.enteringClass.split(",").map((classList) => classList.split(" "));
  }

  get _leavingClassList() {
    return !this.leavingClass ? [[], []] : this.leavingClass.split(",").map((classList) => classList.split(" "));
  }

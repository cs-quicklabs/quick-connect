class ReleaseNotesController < BaseController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to whatsnew_path, notice: "Release Note was successfully deleted.", status: :see_other }
    end
  end

  def whatsnew
    authorize ReleaseNote
    @drafts = ReleaseNote.draft.order(created_at: :desc)
  ...
  def update
    ...
    respond_to do |format|
      ...
      if @release_note.update(release_note_params)
        format.html { redirect_to whatsnew_path, notice: "Release Note was successfully updated." }
      else
  ...
  def create
    ...
    respond_to do |format|
      if @release_note.errors.empty?
        format.html { redirect_to whatsnew_path, notice: "Release Note was successfully created." }
      else

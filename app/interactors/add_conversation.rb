class AddConversation < Patterns::Service
  ...
  def add_event
    contact.events.create(user: actor, action: "conversation", action_for_context: "added a conversation for", trackable: conversation, action_context: "added conversation")
  end

class AddConversation < Patterns::Service
  ...
  def add_event
    contact.events.create(user: actor, action: "conversation", action_for_context:  new conversation for", trackable: conversation, action_context: "added new conversation")
  end

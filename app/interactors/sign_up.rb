class SignUp < Patterns::Service
  ...
  def seed_database
    ...
    ActsAsTenant.with_tenant(account) do
      ...
      SubActivity.create!([{ name: "just hung out", group_id: 1 }, { name: "watched a movie at home", group_id: 1 }, { name: "just talked at home", group_id: 1 },
                           { name: "placed a sport together", group_id: 2 }, { name: "ate at their place", group_id: 3 }, { name: "went to a bar", group_id: 3 },
      ...
      SubEvent.create!([{ name: "started a new job", group_id: 5 }, { name: "retired", group_id: 5 }, { name: "started school", group_id: 5 },
                        { name: "studied abroad", group_id: 5 }, { name: "started voluteering", group_id: 5 }, { name: "published a paper", group_id: 5 },
                        { name: "started a military service", group_id: 5 }, { name: "started a relationship", group_id: 6 }, { name: "got engaged", group_id: 6 }, { "got married", group_id: 6 },

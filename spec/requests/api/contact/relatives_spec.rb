...
RSpec.describe "api/contact/relatives", type: :request do
  ...
  path "/{account_id}/api/contacts/{contact_id}/relatives/new?relative_id={relative_id}" do
    # You'll want to customize the parameter types...
    parameter name: "account_id", in: :path, type: :string, description: "account_id"
    parameter name: "contact_id", in: :path, type: :string, description: "contact_id"
    parameter name: "relative_id", in: :path, type: :string, description: "relative_id"
    get("add relative") do
      security [Bearer: {}]
      produces "application/json"
      consumes "application/json"
